/**
 * State persistence module for SCR plugin.
 * Persists pruned tool IDs across sessions so they survive OpenCode restarts.
 * Storage location: ~/.local/share/opencode/storage/plugin/scr/{sessionId}.json
 */
...
import type { SessionState, SessionStats, CompressSummary } from "./session"
