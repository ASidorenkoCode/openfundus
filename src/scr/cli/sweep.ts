/**
 * SCR Sweep command handler.
 * Reduces tool outputs since the last user message, or the last N tools.
 *
 * Usage:
 *   /scr sweep        - Reduce all tools since the previous user message
 *   /scr sweep 10     - Reduce the last 10 tools
 */

import type { Logger } from "../log"
import type { SessionState, WithParts, ToolParameterEntry } from "../context"
import type { PluginConfig } from "../config"
import { sendIgnoredMessage } from "../notification"
import { formatPrunedItemsList } from "../notification"
import { getCurrentParams, getTotalToolTokens } from "../reducers/helpers"
...
import { getFilePathsFromParameters, isProtected } from "../utils"
